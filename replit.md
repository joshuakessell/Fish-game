...
- **Fire Command Diagnostics:** Added comprehensive logging to HandleFireCommand to track fire rate limits, credit validation, coordinate validation, and successful shots with nonces for debugging.
