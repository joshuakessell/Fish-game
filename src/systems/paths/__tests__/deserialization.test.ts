...
function testLinearPathDeserialization() {
  ...
  assertArrayEquals(result.controlPoints, [[100, 200], [900, 700]], "controlPoints should match");
...
function testSinePathDeserialization() {
  ...
  const tuple: PathDataTuple = [
    ...
    500,                 // startTick
    200,                 // speed
    [[0, 450], [1800, 450], [50, 2]], // controlPoints (start, end, amplitude/frequency)
    10.0,                // duration
    true                 // loop
  ];
...
function testBezierPathDeserialization() {
  ...
  const tuple: PathDataTuple = [
    ...
    2000,                // startTick
    120,                 // speed
    [[0, 0], [300, 600], [1500, 600], [1800, 0]], // controlPoints (P0, P1, P2, P3)
    15.0,                // duration
    false                // loop
  ];
...
function testCircularPathDeserialization() {
  ...
  const tuple: PathDataTuple = [
    ...
    1500,                // startTick
    180,                 // speed
    [[900, 450], [400, 300], [0, 1]], // controlPoints (center, radii, startAngle/clockwise)
    12.0,                // duration
    true                 // loop
  ];
...
function testMultiSegmentPathDeserialization() {
  ...
  const tuple: PathDataTuple = [
    ...
    3000,                // startTick
    140,                 // speed
    [[0, 100], [500, 400], [1200, 300], [1800, 800]], // controlPoints (multiple segments)
    20.0,                // duration
    false                // loop
  ];
  ...
  assertArrayEquals(
    result.controlPoints,
    [[0, 100], [500, 400], [1200, 300], [1800, 800]],
    "controlPoints should match"
  );
